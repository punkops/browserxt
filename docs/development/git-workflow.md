...
Fork the repository to your own namespace, and let us take `https://github.com/<username>/browserxt` as example.

Clone the repository and navigate to the root directory:

```shell
git clone git@github.com:<username>/browserxt.git
cd browserxt
```
...
```shell
git remote add upstream https://github.com/punkops/browserxt
git fetch upstream
```
...
```shell
git remote set-url --push upstream git@github.com/<username>/browserxt.git
```
...
```shell
origin  git@github.com:<username>/browserxt.git (fetch)
origin  git@github.com:<username>/browserxt.git (push)
upstream        https://github.com/punkops/browserxt (fetch)
upstream        git@github.com:<username>/browserxt.git (push)
```
